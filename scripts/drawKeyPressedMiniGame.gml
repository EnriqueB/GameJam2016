...
if(x < view_xview[1]) {
    ...
    if (global.indexNumber >= 1) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 30, 200, global.keys[0, 0]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 30, 200, global.keys[1, 0]);
    if (global.indexNumber >= 2) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 80, 200, global.keys[0, 1]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 80, 200, global.keys[1, 1]);
    if (global.indexNumber >= 3) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 130, 200, global.keys[0, 2]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 130, 200, global.keys[1, 2]);
    if (global.indexNumber >= 4) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 180, 200, global.keys[0, 3]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 180, 200, global.keys[1, 3]);
    if (global.indexNumber >= 5) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 230, 200, global.keys[0, 4]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 230, 200, global.keys[1, 4]);
    if (global.indexNumber >= 6) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 280, 200, global.keys[0, 5]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 280, 200, global.keys[1, 5]);
    if (global.indexNumber >= 7) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 330, 200, global.keys[0, 6]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 330, 200, global.keys[1, 6]);
    if (global.indexNumber >= 8) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 380, 200, global.keys[0, 7]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 380, 200, global.keys[1, 7]);
    if (global.indexNumber >= 9) drawSingleKey(c_blue, font_Jing_Jing, view_xview[1] + 430, 200, global.keys[0, 8]) else drawSingleKey(c_black, font_Jing_Jing, view_xview[1] + 410, 200, global.keys[1, 8]);
}
